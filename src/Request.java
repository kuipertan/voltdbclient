...
public class Request implements JsonToVoltdb {
	...
	public String	session2year;
	public String	session6moth;
	public String	session2hour;
	public Integer	ignore_domain;
	public String	rule;
	public Integer	store;
	public String	item_target_type;
	public String	callback;
	public String	format;
	public Integer	include_base;
	...
	*/
	...
	String[] keys = new String[]{
		"item_id", "gid", "user_id", "session_id", "uuid", "req_id", "request_name", 
	...
	public boolean WriteToVoltdb(Client client) {
		// TODO Auto-generated method stub
		   try { 	
			   /*
			   ClientResponse resp = client.callProcedure("REQUEST_WRITE", 
					   item_id, gid, user_id, session_id, uuid, req_id, 
					   request_name, category, category_id, brand, 
					   brand_id, days, ratio, filter, ip, ref_page, 
					   creation_time, insert_time,session2year, session6moth, 
					   session2hour, ignore_domain, rule, store, callback, 
					   format, include_base, page_type, banner_id, order_num, 
					   num, type, base_num, et, t_cid, spam
   						);
   						*/
			   	ClientResponse resp = client.callProcedure("REQUEST.insert", 
					   ...
					   kvs.get(keys[35]),kvs.get(keys[36])
   						);
